...
<body>
    ...
    <div id="main">
        <div id="topOne" style="background-image: url(img/mainPage/main.jpg)">
            <div class="main_slogan">중앙주 시민의 꿈을 펼쳐 갈 미래 유비쿼터스,<br><span>중앙주시 도서관</span>입니다.</div>
            <div id="divgroup">
                <div id="div1">
            ...
            <div id="divgroup2">
                ...
                <div class="mainevent">
                    ...
                    <div class="eventmiddle ">
                        <a href="">
                            <p>중앙주 도서관 북드라이브 스루(도서예약대출시스템)</p>
                        </a>
                        <a href="">
                            <p></p>
                        </a>
                    ...
                    <div class="eventlist">
                        <ul>
                            <li>     중앙 도서관 북드라이브 스루(도서예약대출 서비스) 운영 안내</li>
                            <li>코로나19 중앙시 예방대책 및 선별진료소 현황</li>
                            <li>중앙시 도서관 휴관 안내</li>
                            <li>5월 자원봉사 안내</li>
                            <li>토요 영화상영 및 문화프로그램 잠정 중단 안내</li>
                        </ul>
                    </div>
            ...
            <div id="bookgroup">
                <div id="bookBest">
                    <ul class="booklist">
                        ...
                        <a href="">
                            <li><img src='<c:url value="/resources/img/mainPage/knight.jpg"/>' alt="">
                                <p class="booktitle">(The)Knight of silk and steel</p>
                                <p class="bookinfo">by Terry Deary, illustrated by Helen Flook</p>
                            </li>
                        </a>
                        <a href="">
                            <li><img src='<c:url value="/resources/img/mainPage/textbook.jpg"/>' alt="">
                                <p class="booktitle">(초급부터 중급까지 쉽게 따라 할 수 있는)레진공예의 교과서</p>
                                <p class="bookinfo">구마자키 겐이치 지음 ; 박재영 옮김
</p>
                            </li>
                        </a>
                        <a href="">
                            <li><img src='<c:url value="/resources/img/mainPage/today.jpg"/>' alt="">
                                <p class="booktitle">오늘도 대한민국은 이상 기후입니다!</p>
                                <p class="bookinfo">신방실 글 ; 임진아 그림</p>
                            </li>
                        </a>
                        <a href="">
                            <li><img src='<c:url value="/resources/img/mainPage/magic.jpg"/>' alt="">
                                <p class="booktitle">마력의 태동</p>
                                <p class="bookinfo">히가시노 게이고 지음 ; 양윤옥 옮김</p>
                            </li>
                        </a>
                    </ul>
                </div>
