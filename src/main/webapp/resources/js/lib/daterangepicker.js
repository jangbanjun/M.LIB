...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.minYear = moment().subtract(1, 'year').format('YYYY');
//        this.minYear = moment().format('YYYY');
//        this.maxYear = moment().add(100, 'year').format('YYYY');
        this.maxYear = moment().add(1,'year').format('YYYY');
...
//                }
                if (newValue !== this.element.val() && this.singleDatePicker) {
